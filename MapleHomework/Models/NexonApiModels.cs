...
namespace MapleHomework.Models
{
    ...
    public class HexaMatrixStatResponse
    {
        [JsonPropertyName("character_class")]
        public string? CharacterClass { get; set; }
        [JsonPropertyName("character_hexa_stat_core")]
        public List<HexaStatCoreInfo>? CharacterHexaStatCore { get; set; }
        [JsonPropertyName("character_hexa_stat_core_2")]
        public List<HexaStatCoreInfo>? CharacterHexaStatCore2 { get; set; }
        [JsonPropertyName("character_hexa_stat_core_3")]
        public List<HexaStatCoreInfo>? CharacterHexaStatCore3 { get; set; }
    }

    public class HexaStatCoreInfo
    {
        [JsonPropertyName("slot_id")]
        public string? SlotId { get; set; }
        [JsonPropertyName("main_stat_name")]
        public string? MainStatName { get; set; }
        [JsonPropertyName("sub_stat_name_1")]
        public string? SubStatName1 { get; set; }
        [JsonPropertyName("sub_stat_name_2")]
        public string? SubStatName2 { get; set; }
        [JsonPropertyName("main_stat_level")]
        public int MainStatLevel { get; set; }
        [JsonPropertyName("sub_stat_level_1")]
        public int SubStatLevel1 { get; set; }
        [JsonPropertyName("sub_stat_level_2")]
        public int SubStatLevel2 { get; set; }
        [JsonPropertyName("stat_grade")]
    ...
    public class RingExchangeResponse
    {
